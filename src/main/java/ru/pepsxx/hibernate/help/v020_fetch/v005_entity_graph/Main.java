...
public class Main {
    public static void main(String[] args) {
        ...
        try (SessionFactory sessionFactory = configuration.buildSessionFactory()) {
            ...
            EntityGraph<Person> entityGraph = session.createEntityGraph(Person.class); // Создаём граф
            entityGraph.addSubgraph("items"); // Указываем какую сущность подгружать
            ...
            session.getTransaction().commit();  // No LazyInitializationException
